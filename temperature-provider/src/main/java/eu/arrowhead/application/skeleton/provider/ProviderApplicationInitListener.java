...
public class ProviderApplicationInitListener extends ApplicationInitListener {
	...
	private void publishDestroyedEvent() {
		...
		publisherService.publish(PresetEventType.TEMPERATURE_PROVIDER_DESTROYED, (Map<String, String>) null,
				PublisherConstants.TEMPERATURE_PROVIDER_DESTROYED_PAYLOAD);
	...
	private void publishInitStartedEvent() {
		...
		publisherService.publish(PresetEventType.TEMPERATURE_START_INIT, (Map<String, String>) null,
				PublisherConstants.TEMPERATURE_START_PAYLOAD);
	}
